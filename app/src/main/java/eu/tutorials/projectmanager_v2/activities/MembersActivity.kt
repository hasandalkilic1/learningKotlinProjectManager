    ...
    private fun dialogSearchMember(){
        ...
        dialog.tv_add.setOnClickListener {
            ...
            if (email.isNotEmpty()){
                dialog.dismiss()
                showProgressDialog(resources.getString(R.string.please_wait))
                FirestoreClass().getMemberDetails(this,email,resources.getString(R.string.no_such_member_found))
            }
            else{
                Toast.makeText(this,"Please add a email address",Toast.LENGTH_SHORT).show()
            }
        }
